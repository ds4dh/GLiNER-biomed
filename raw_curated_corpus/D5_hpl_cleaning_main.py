...
from D4_hpl_cleaning_worker import process_single_text
...
def process_csv(input_csv, output_csv, thresholds, text_column="text"):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Process and clean a CSV file with quality heuristics.")
    ...
    parser.add_argument('--max_newline_to_sentence_ratio', type=float, default=0.5, help="Maximum newline to sentence ratio.")
